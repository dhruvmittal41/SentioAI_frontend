...
const Message = ({ text, text2, text3 }) => {
  return (
    <div className="bg-gradient-to-b from-night via-night2 to-night3 w-screen h-screen flex justify-center items-center px-4">
      <Box className="bg-offwhite w-full max-w-xl h-auto min-h-[30vh] flex flex-col justify-center items-center rounded-[2.5vw] text-red-600 text-center p-6 sm:p-8 gap-4">
        <p className="text-xl sm:text-2xl">{text}</p>
        <p className="text-xl sm:text-2xl">{text2}</p>
        <p className="text-xl sm:text-2xl">{text3}</p>
